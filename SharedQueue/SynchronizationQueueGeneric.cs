...
namespace Microsoft.WebSolutionsPlatform.Common
{
	...
	public class SynchronizationQueueGeneric<T> : Queue<T>, IDisposable
	{
		...
		public SynchronizationQueueGeneric( PerformanceCounter performanceCounter )
            : base()
        {
        ...
        /// <param name="capacity">The initial number of elements that the Generic Queue can contain</param>
        /// <param name="performanceCounter">Performance counter showing size of queue.</param>
        public SynchronizationQueueGeneric(int capacity, PerformanceCounter performanceCounter)
            : base(capacity)
        {
            this.performanceCounter = performanceCounter;
            this.performanceCounter.RawValue = 0;
		...
		public SynchronizationQueueGeneric( IEnumerable<T> collection )
			: base(collection)
		{
		}
        ...
        /// <param name="collection">The collection whose elements are copied to the new Generic Queue</param>
        /// <param name="performanceCounter">Performance counter showing size of queue.</param>
        public SynchronizationQueueGeneric(IEnumerable<T> collection, PerformanceCounter performanceCounter)
            : base(collection)
        {
            this.performanceCounter = performanceCounter;
            this.performanceCounter.RawValue = 0;
